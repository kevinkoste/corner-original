...
export const EditBookshelf: React.FC<BookshelfComponent> = ({ id, props }) => {
  ...
  const placeholder = [
    {
      ...
      date: '2002',
      link:
        'https://books.google.com/books?id=7HpQAAAAMAAJ&dq=thedreammachine&hl=&source=gbs_api',
      image:
        'https://books.google.com/books/content?id=7HpQAAAAMAAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api',
    },
    {
      id: '2',
      title: 'Little Women',
      ...
      date: '1880',
      link:
        'https://play.google.com/store/books/details?id=xHbaFO0ow3kC&source=gbs_api',
      image:
        'https://books.google.com/books/content?id=xHbaFO0ow3kC&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api',
    },
  ]
  ...
  if (
    ...
    profileState.profile.components.find((comp) => comp.type === 'bookshelf')
      ?.props.books.length === 0
  ) {
    return (
      <ComponentContainer column width={12}>
        <H1 style={{ color: 'lightgray' }}>Bookshelf</H1>
        ...
        <Div column width={12} style={{ position: 'relative' }}>
          ...
          <AddButton onClick={onAddClick}>Add books</AddButton>
        </Div>
      </ComponentContainer>
    )
