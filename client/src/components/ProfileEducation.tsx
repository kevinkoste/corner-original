...
// import { Education, EducationComponent } from '../models/Profile'
...
// export const EducationSection: React.FC<EducationComponent> = ({ id, props }) => {
...
// 				{ profileState.profile.components.find(comp => comp.type === 'education')?.props.education.map((data: any, idx: number) => 
// 					<EducationEditRow
// 						key={idx}
// 						data={data}
// 					/>
